...
class _AddEventState extends State<AddEvent> {
  ...
  List get formInputs {
    ...
    return [
      ...
      // faire apparaitre le contenu de la checklist
      if(eventParameters["associated_list"] != null)
        Container(
  ...
  /// Liste des options de temps de journee
